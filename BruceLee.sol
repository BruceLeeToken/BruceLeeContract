...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 OneInch = IBEP20(0x111111111117dC0aa78b770fA6A738034120C302);
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 1 OneInch minimum auto send
...
contract BRUCELEE is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _symbol = "1INCHPUNCH";
    ...
    uint256 totalBuyFee = buybackFee.add(reflectionFee).add(marketingFee);
    ...
    uint256 public buyBackUpperLimit = 2 * 10**18;
    bool inSwap;
    ...
    function canSwap() internal view returns (bool) {
        return msg.sender != pancakeV2BNBPair && !inSwap;
    }
